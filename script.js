...
alert(`Welcome to "GUESS THAT NUMBER!" Please click "OK" to start the game. --- A way to incorporate this project into my Portfolio is to use it as a navigational tool to lead the potential employer to some random bit of information. Not only will this showcase the skill but it will give me the opportunity to interact with the person individually before we even officially meet---` );
